...
export const PrivacyTab = ({ isPhone }: { isPhone: boolean }) => {
    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
          <div>
            <h4 className="font-medium text-gray-900">Não receber E-mails</h4>
            <p className="text-sm text-gray-500">Não desejo receber e-mails</p>
          </div>
